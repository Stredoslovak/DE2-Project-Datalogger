...
/* Initialize BME280 device and basic settings. Caller must call `twi_init()` first.
 * dev_addr: 7-bit I2C address (e.g. BME280_I2C_ADDR_PRIM)
 * Returns BME280_OK (0) on success or negative error code.
 */
...
/* Perform one forced measurement and return compensated values.
 * t100: temperature in 0.01 degC
 * press_pa: pressure in Pa
 * hum_x1024: humidity in percent * 1024
